...
| ballista.optimizer.reuse_exchange_enabled              | Boolean | true                          | Reuse structurally-identical shuffle exchanges across the stage DAG so a repeated subplan is materialized once (Spark ReuseExchange analog)                                                                                                                                                                                                                                                                              |
