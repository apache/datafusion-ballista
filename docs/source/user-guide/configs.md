...
| key                                          | type   | default        | description                                                                                                                                                                                 |
| -------------------------------------------- | ------ | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| scheduler-id                                 | Utf8   | generated UUID | Sets the opaque scheduler identity exposed in scheduler state and history event logs. The default matches executor UUID-backed instance ids. Executor callbacks use the scheduler endpoint. |
