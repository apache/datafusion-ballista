...
use kapot_core::serde::protobuf::executor_grpc_client::ExecutorGrpcClient;
use kapot_core::serde::protobuf::{
...
use kapot_core::utils::{create_grpc_client_connection, get_time_before};
use dashmap::DashMap;
    ...
    pub(crate) fn is_dead_executor(&self, executor_id: &str) -> bool {
        self.cluster_state
            ...
            .map_or(true, |heartbeat| {
                matches!(
                    heartbeat.status,
                    Some(kapot_core::serde::generated::kapot::ExecutorStatus {
