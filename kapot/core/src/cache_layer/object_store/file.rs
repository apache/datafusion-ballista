...
use kapot_cache::loading_cache::LoadingCache;
use bytes::Bytes;
    ...
    M: CacheMedium,
{
    async fn put(
        ...
        Err(Error::NotSupported {
            source: Box::new(KapotError::General(
    ...
    async fn list_with_delimiter(
        ...
        Err(Error::NotSupported {
            source: Box::new(KapotError::General("List is not supported".to_string())),
        })
    }

    async fn copy(&self, _from: &Path, _to: &Path) -> object_store::Result<()> {
        Err(Error::NotSupported {
            source: Box::new(KapotError::General("Copy is not supported".to_string())),
        })
    }
