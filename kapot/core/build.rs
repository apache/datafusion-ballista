...
fn main() -> Result<(), String> {
    ...
    #[cfg(feature = "docsrs")]
    let path = out.join("kapot.rs");
    #[cfg(not(feature = "docsrs"))]
    let path = "src/serde/generated/kapot.rs";
    ...
    if Path::new("proto/datafusion.proto").exists() {
        ...
        println!("cargo:rerun-if-changed=proto/kapot.proto");
        tonic_build::configure()
            .extern_path(".datafusion_common", "::datafusion_proto_common")
            .extern_path(".datafusion", "::datafusion_proto::protobuf")
            .protoc_arg("--experimental_allow_proto3_optional")
            .compile_protos(&["proto/kapot.proto"], &["proto"])
            .map_err(|e| format!("protobuf compilation failed: {e}"))?;
        let generated_source_path = out.join("kapot.protobuf.rs");
