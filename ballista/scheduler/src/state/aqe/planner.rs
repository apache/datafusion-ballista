...
use crate::state::aqe::optimizer_rule::{
    ...
    EliminateRoundRobbinRule, PropagateEmptyExecRule, WarnOnDuplicateExecRule,
};
...
impl AdaptivePlanner {
    ...
    pub(crate) fn cancellable_stages(&mut self) -> common::Result<CancellableStageIds> {
