...
/// It's a fork version of hashlink[https://github.com/triplehex/hashlink] mainly to deal with version
/// issue of hashbrown. Later we will propose PR to the original hashlink to update the hashbrown version
use std::{
    alloc::Layout,
    borrow::Borrow,
    cmp::Ordering,
